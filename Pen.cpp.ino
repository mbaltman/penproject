...
Stepper stepMotorL(step_360,2,3,4,5);
...
{
    //some conversion between how dar we want to move and the distacne passed in. 
    int stepSize =10;
    int iterations = abs(distance);
    
    //this will make stepSize negative if distacne is negative
    int stepSize = stepSize * (distance/ abs(distance));
